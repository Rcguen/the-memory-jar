            ...
            <div className="relative flex flex-col gap-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-zinc-300/85">
              ...
              {groups.map((group) => (
                ...
                >
                  <div
                    ...
                    className="sticky top-3 z-20 mb-4 inline-flex rounded-full border border-white/12 bg-zinc-950/65 px-4 py-2 font-cormorant text-2xl text-zinc-50 shadow-lg backdrop-blur-xl"
                  >
                    {group.year}
                  </div>
                  ...
                  <div className="space-y-6">
                    {group.months.map((month) => (
                      <div key={month.key} className="rounded-[1.5rem] border border-white/10 bg-white/50 p-4 backdrop-blur-xl dark:bg-zinc-950/35 sm:p-5">
                        ...
                        <div className="space-y-3">
                          {month.memories.map((memory) => (
                            <motion.button
                              ...
                              className="group flex w-full items-start gap-4 rounded-[1.2rem] border border-white/10 bg-white/70 px-4 py-4 text-left transition-colors hover:bg-white/85 dark:bg-zinc-950/50 dark:hover:bg-zinc-900/58"
                            >
                              ...
                              <span className="mt-1 inline-flex shrink-0 items-center gap-1 text-sm text-zinc-500 transition-transform group-hover:translate-x-1 dark:text-zinc-300">
                                Open
